(set-logic QF_S)
(declare-fun _var_0xINPUT_49980_() String)
...
(assert (=(str.++ _var_0xINPUT_49980_  "")(str.++ __woorpje_diseq_pref1_  "B" __woorpje_diseq_suf_l1_  "")) )
(assert (=(str.++  "K9BOAGJDFi" "")(str.++ __woorpje_diseq_pref1_  "O" __woorpje_diseq_suf_r1_  "")) )
(assert (=(str.++  "K9BOAGJDFi" "")(str.++ __woorpje_diseq_pref2_  "O" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++ _var_0xINPUT_49980_  "")(str.++ __woorpje_diseq_pref2_  "B" __woorpje_diseq_suf_r2_  "")) )
(assert (=(str.++ _var_0xINPUT_49980_  "")(str.++ __woorpje_diseq_pref1_  "B" __woorpje_diseq_suf_l1_  "")) )
(assert (=(str.++  "K9BOAGJDFi" "")(str.++ __woorpje_diseq_pref1_  "O" __woorpje_diseq_suf_r1_  "")) )
(assert (=(str.++  "K9BOAGJDFi" "")(str.++ __woorpje_diseq_pref2_  "O" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++ _var_0xINPUT_49980_  "")(str.++ __woorpje_diseq_pref2_  "B" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_49980_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_49980_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_49980_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_49980_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_49980_)(- 1)) (- 1)) )
...
(assert  (<= (* (str.len _var_0xINPUT_49980_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_49980_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_49980_)1) 7) )
(assert  (<= (* (str.len _var_0xINPUT_49980_)(- 1)) (- 1)) )
(check-sat)
