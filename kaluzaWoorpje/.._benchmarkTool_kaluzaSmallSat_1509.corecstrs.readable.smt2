(set-logic QF_S)
(declare-fun _var_0xINPUT_137236_() String)
...
(assert (=(str.++ _var_0xINPUT_137236_  "")(str.++ __woorpje_diseq_pref3_  "p" __woorpje_diseq_suf_l3_  "")) )
(assert (=(str.++  "4PH2ujcENG" "")(str.++ __woorpje_diseq_pref3_  "G" __woorpje_diseq_suf_r3_  "")) )
(assert (=(str.++ _var_0xINPUT_137236_  "")(str.++ __woorpje_diseq_pref3_  "p" __woorpje_diseq_suf_l3_  "")) )
(assert (=(str.++  "4PH2ujcENG" "")(str.++ __woorpje_diseq_pref3_  "G" __woorpje_diseq_suf_r3_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_137236_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_137236_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_137236_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_137236_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_137236_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_137236_)(- 1)) (- 1)) )
