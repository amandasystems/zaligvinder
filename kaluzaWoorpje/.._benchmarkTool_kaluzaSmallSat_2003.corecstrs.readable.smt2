(set-logic QF_S)
(declare-fun _var_0xINPUT_264608_() String)
...
(assert (=(str.++ _var_0xINPUT_264608_  "")(str.++ __woorpje_diseq_pref2_  "A" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "CQALcCP5TB" "")(str.++ __woorpje_diseq_pref2_  "L" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_264608_)1) 9) )
(assert  (<= (* (str.len _var_0xINPUT_264608_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_264608_)1) 9) )
(assert  (<= (* (str.len _var_0xINPUT_264608_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_264608_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_264608_)(- 1)) (- 1)) )
