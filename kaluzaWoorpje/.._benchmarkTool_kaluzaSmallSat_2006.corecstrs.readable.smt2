(set-logic QF_S)
(declare-fun _var_0xINPUT_96267_() String)
...
(assert (=(str.++ _var_0xINPUT_96267_  "")(str.++ __woorpje_diseq_pref4_  "c" __woorpje_diseq_suf_l4_  "")) )
(assert (=(str.++  "4PH2ujcENG" "")(str.++ __woorpje_diseq_pref4_  "N" __woorpje_diseq_suf_r4_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_96267_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_96267_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_96267_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_96267_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_96267_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_96267_)(- 1)) (- 1)) )
