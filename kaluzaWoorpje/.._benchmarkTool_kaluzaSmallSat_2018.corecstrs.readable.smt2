(set-logic QF_S)
(declare-fun _var_0xINPUT_170080_() String)
...
(assert (=(str.++ _var_0xINPUT_170080_  "")(str.++ __woorpje_diseq_pref2_  "d" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "qXdHDo7IZR" "")(str.++ __woorpje_diseq_pref2_  "R" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_170080_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_170080_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_170080_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_170080_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_170080_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_170080_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_170080_)(- 1)) (- 1)) )
