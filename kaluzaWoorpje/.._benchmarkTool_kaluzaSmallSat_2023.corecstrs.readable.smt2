(set-logic QF_S)
(declare-fun _var_0xINPUT_345319_() String)
...
(assert (=(str.++ _var_0xINPUT_345319_  "")(str.++ __woorpje_diseq_pref3_  "l" __woorpje_diseq_suf_l3_  "")) )
(assert (=(str.++  "2vbcJ9lN6J" "")(str.++ __woorpje_diseq_pref3_  "6" __woorpje_diseq_suf_r3_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_345319_)1) 9) )
(assert  (<= (* (str.len _var_0xINPUT_345319_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_345319_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_345319_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_345319_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_345319_)(- 1)) (- 1)) )
