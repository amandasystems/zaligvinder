(set-logic QF_S)
(declare-fun _var_0xINPUT_146475_() String)
...
(assert (=(str.++ _var_0xINPUT_146475_  "")(str.++ __woorpje_diseq_pref0_  "q" __woorpje_diseq_suf_r0_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_146475_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_146475_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_146475_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_146475_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_146475_)(- 1)) (- 1)) )
