(set-logic QF_S)
(declare-fun _var_0xINPUT_174060_() String)
...
(assert (=(str.++ _var_0xINPUT_174060_  "")(str.++ __woorpje_diseq_pref2_  "d" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "ND6MEXdqBD" "")(str.++ __woorpje_diseq_pref2_  "B" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_174060_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_174060_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_174060_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_174060_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_174060_)(- 1)) (- 1)) )
