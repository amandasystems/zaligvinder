(set-logic QF_S)
(declare-fun _var_0xINPUT_66688_() String)
...
(assert (=(str.++ _var_0xINPUT_66688_  "")(str.++ __woorpje_diseq_pref3_  "7" __woorpje_diseq_suf_l3_  "")) )
(assert (=(str.++  "3s71lxYG6e" "")(str.++ __woorpje_diseq_pref3_  "e" __woorpje_diseq_suf_r3_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_66688_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_66688_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_66688_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_66688_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_66688_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_66688_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_66688_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_66688_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_66688_)(- 1)) (- 1)) )
(check-sat)
