(set-logic QF_S)
(declare-fun _var_0xINPUT_243357_() String)
...
(assert (=(str.++ _var_0xINPUT_243357_  "")(str.++ __woorpje_diseq_pref2_  "l" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "Example:" "")(str.++ __woorpje_diseq_pref2_  "E" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_243357_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_243357_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_243357_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_243357_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_243357_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_243357_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_243357_)1) 9) )
(check-sat)
