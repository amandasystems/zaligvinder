(set-logic QF_S)
(declare-fun _var_0xINPUT_30626_() String)
...
(assert (=(str.++ _var_0xINPUT_30626_  "")(str.++ __woorpje_diseq_pref3_  "a" __woorpje_diseq_suf_l3_  "")) )
(assert (=(str.++  "qXdHDo7IZR" "")(str.++ __woorpje_diseq_pref3_  "R" __woorpje_diseq_suf_r3_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_30626_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_30626_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_30626_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_30626_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_30626_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_30626_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_30626_)(- 1)) (- 9)) )
(check-sat)
