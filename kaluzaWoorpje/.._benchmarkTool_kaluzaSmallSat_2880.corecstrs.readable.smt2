(set-logic QF_S)
(declare-fun _var_0xINPUT_245832_() String)
...
(assert (=(str.++ _var_0xINPUT_245832_  "")(str.++ __woorpje_diseq_pref1_  "l" __woorpje_diseq_suf_l1_  "")) )
(assert (=(str.++  "Example:" "")(str.++ __woorpje_diseq_pref1_  ":" __woorpje_diseq_suf_r1_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_245832_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_245832_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_245832_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_245832_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_245832_)(- 1)) (- 1)) )
