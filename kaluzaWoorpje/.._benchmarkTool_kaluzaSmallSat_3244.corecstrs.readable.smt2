(set-logic QF_S)
(declare-fun _var_0xINPUT_271632_() String)
...
(assert (=(str.++ _var_0xINPUT_271632_  "")(str.++ __woorpje_diseq_pref2_  "U" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "ywUN4ZIDAC" "")(str.++ __woorpje_diseq_pref2_  "C" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_271632_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_271632_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_271632_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_271632_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_271632_)(- 1)) (- 1)) )
(check-sat)
