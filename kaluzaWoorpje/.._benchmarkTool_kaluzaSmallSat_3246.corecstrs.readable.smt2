(set-logic QF_S)
(declare-fun _var_0xINPUT_468093_() String)
...
(assert (=(str.++  "ND6MEXdqBD" "")(str.++ __woorpje_diseq_pref2_  "E" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++ _var_0xINPUT_468093_  "")(str.++ __woorpje_diseq_pref2_  "B" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_468093_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_468093_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_468093_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_468093_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_468093_)(- 1)) (- 1)) )
(check-sat)
