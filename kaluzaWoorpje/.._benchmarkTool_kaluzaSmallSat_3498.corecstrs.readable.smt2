(set-logic QF_S)
(declare-fun _var_0xINPUT_131036_() String)
...
(assert (=(str.++  "AA1ND6MEXd" "")(str.++ _var_0xINPUT_131036_  "")) )
(assert (=(str.++ _var_0xINPUT_131036_  "")(str.++  "AA1ND6MEXd" "")) )
(assert  (<= (* (str.len _var_0xINPUT_131036_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_131036_)(- 1)) (- 9)) )
(check-sat)
