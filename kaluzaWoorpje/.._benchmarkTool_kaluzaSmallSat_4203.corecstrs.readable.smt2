(set-logic QF_S)
(declare-fun _var_0xINPUT_168214_() String)
...
(assert (=(str.++ _var_0xINPUT_168214_  "")(str.++ __woorpje_diseq_pref1_  "Z" __woorpje_diseq_suf_l1_  "")) )
(assert (=(str.++  "ywUN4ZIDAC" "")(str.++ __woorpje_diseq_pref1_  "C" __woorpje_diseq_suf_r1_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_168214_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_168214_)(- 1)) (- 1)) )
(check-sat)
