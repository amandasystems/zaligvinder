(set-logic QF_S)
(declare-fun _var_0xINPUT_63096_() String)
...
(assert (=(str.++ _var_0xINPUT_63096_  "")(str.++ __woorpje_diseq_pref2_  "Z" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "ywUN4ZIDAC" "")(str.++ __woorpje_diseq_pref2_  "C" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_63096_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_63096_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_63096_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_63096_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_63096_)(- 1)) (- 1)) )
