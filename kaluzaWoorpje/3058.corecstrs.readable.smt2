(set-logic QF_S)
(declare-fun _var_0xINPUT_35391_() String)
...
(assert (=(str.++ _var_0xINPUT_35391_  "")(str.++  "Example:" "")) )
(assert  (<= (* (str.len _var_0xINPUT_35391_)1) 9) )
(assert  (<= (* (str.len _var_0xINPUT_35391_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_35391_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_35391_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_35391_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_35391_)(- 1)) (- 1)) )
