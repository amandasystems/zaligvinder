(set-logic QF_S)
(declare-fun _var_0xINPUT_131377_() String)
...
(assert (=(str.++  "AA1ND6MEXd" "")(str.++ _var_0xINPUT_131377_  "")) )
(assert (=(str.++ _var_0xINPUT_131377_  "")(str.++ __woorpje_diseq_pref2_  "A" __woorpje_diseq_suf_l2_  "")) )
...
(assert (=(str.++ _var_0xINPUT_131377_  "")(str.++ __woorpje_diseq_pref3_  "A" __woorpje_diseq_suf_r3_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_131377_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_131377_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_131377_)(- 1)) (- 1)) )
(check-sat)
