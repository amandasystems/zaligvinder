...
(assert (=(str.++ _var_0xINPUT_127631_  "")(str.++ __woorpje_diseq_pref2_  "I" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "qXdHDo7IZR" "")(str.++ __woorpje_diseq_pref2_  "R" __woorpje_diseq_suf_r2_  "")) )
(assert (=(str.++ _var_0xINPUT_127631_  "")(str.++ __woorpje_diseq_pref2_  "I" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "qXdHDo7IZR" "")(str.++ __woorpje_diseq_pref2_  "R" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_127631_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_127631_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_127631_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_127631_)(- 1)) (- 1)) )
(check-sat)
