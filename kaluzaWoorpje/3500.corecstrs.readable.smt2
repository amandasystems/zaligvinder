(set-logic QF_S)
(declare-fun _var_0xINPUT_133844_() String)
...
(assert (=(str.++  "4PH2ujcENG" "")(str.++ _var_0xINPUT_133844_  "")) )
(assert (=(str.++ _var_0xINPUT_133844_  "")(str.++  "4PH2ujcENG" "")) )
(assert  (<= (* (str.len _var_0xINPUT_133844_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_133844_)(- 1)) (- 9)) )
(check-sat)
