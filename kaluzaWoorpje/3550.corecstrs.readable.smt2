(set-logic QF_S)
(declare-fun _var_0xINPUT_82263_() String)
...
(assert (=(str.++ _var_0xINPUT_82263_  "")(str.++ __woorpje_diseq_pref0_  "3" __woorpje_diseq_suf_r0_  "")) )
(assert (=(str.++ _var_0xINPUT_82263_  "")(str.++  "3s71lxYG6e" "")) )
(assert  (<= (* (str.len _var_0xINPUT_82263_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_82263_)(- 1)) (- 9)) )
(check-sat)
