(set-logic QF_S)
(declare-fun _var_0xINPUT_142380_() String)
...
(assert (=(str.++ _var_0xINPUT_142380_  "")(str.++  "CQALcCP5TB" "")) )
(assert  (<= (* (str.len _var_0xINPUT_142380_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_142380_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_142380_)(- 1)) (- 9)) )
(check-sat)
