...
(assert (=(str.++ _var_0xINPUT_100253_  "")(str.++ __woorpje_diseq_pref0_  "2" __woorpje_diseq_suf_r0_  "")) )
(assert (=(str.++ _var_0xINPUT_100253_  "")(str.++  "2vbcJ9lN6J" "")) )
(assert  (<= (* (str.len _var_0xINPUT_100253_)(- 1)) (- 1)) )
(check-sat)
