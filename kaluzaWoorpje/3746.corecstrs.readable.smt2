(set-logic QF_S)
(declare-fun _var_0xINPUT_106528_() String)
...
(assert (=(str.++ _var_0xINPUT_106528_  "")(str.++ __woorpje_diseq_pref0_  "3" __woorpje_diseq_suf_r0_  "")) )
(assert (=(str.++ _var_0xINPUT_106528_  "")(str.++  "3s71lxYG6e" "")) )
(assert  (<= (* (str.len _var_0xINPUT_106528_)(- 1)) (- 1)) )
(check-sat)
