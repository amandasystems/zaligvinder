(set-logic QF_S)
(declare-fun _var_0xINPUT_97106_() String)
...
(assert (=(str.++ _var_0xINPUT_97106_  "")(str.++  "Example:" "")) )
(assert  (<= (* (str.len _var_0xINPUT_97106_)1) 9) )
(assert  (<= (* (str.len _var_0xINPUT_97106_)(- 1)) (- 1)) )
(check-sat)
