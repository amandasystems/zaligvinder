(set-logic QF_S)
(declare-fun _var_0xINPUT_187567_() String)
...
(assert (=(str.++ _var_0xINPUT_187567_  "")(str.++ __woorpje_diseq_pref2_  "5" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "CQALcCP5TB" "")(str.++ __woorpje_diseq_pref2_  "B" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_187567_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_187567_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_187567_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_187567_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_187567_)(- 1)) (- 1)) )
