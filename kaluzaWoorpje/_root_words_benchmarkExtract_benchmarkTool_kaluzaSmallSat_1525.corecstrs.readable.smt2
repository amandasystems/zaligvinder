(set-logic QF_S)
(declare-fun _var_0xINPUT_154701_() String)
...
(assert (=(str.++ _var_0xINPUT_154701_  "")(str.++ __woorpje_diseq_pref3_  "U" __woorpje_diseq_suf_l3_  "")) )
(assert (=(str.++  "ywUN4ZIDAC" "")(str.++ __woorpje_diseq_pref3_  "C" __woorpje_diseq_suf_r3_  "")) )
(assert (=(str.++ _var_0xINPUT_154701_  "")(str.++ __woorpje_diseq_pref3_  "U" __woorpje_diseq_suf_l3_  "")) )
(assert (=(str.++  "ywUN4ZIDAC" "")(str.++ __woorpje_diseq_pref3_  "C" __woorpje_diseq_suf_r3_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_154701_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_154701_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_154701_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_154701_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_154701_)(- 1)) (- 1)) )
...
(assert  (<= (* (str.len _var_0xINPUT_154701_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_154701_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_154701_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_154701_)(- 1)) (- 1)) )
(check-sat)
