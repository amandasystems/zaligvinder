(set-logic QF_S)
(declare-fun _var_0xINPUT_94007_() String)
...
(assert (=(str.++ _var_0xINPUT_94007_  "")(str.++ __woorpje_diseq_pref4_  ":" __woorpje_diseq_suf_l4_  "")) )
(assert (=(str.++  "Example:" "")(str.++ __woorpje_diseq_pref4_  "E" __woorpje_diseq_suf_r4_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_94007_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_94007_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_94007_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_94007_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_94007_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_94007_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_94007_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_94007_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_94007_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_94007_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_94007_)(- 1)) (- 11)) )
