(set-logic QF_S)
(declare-fun _var_0xINPUT_126279_() String)
...
(assert (=(str.++ _var_0xINPUT_126279_  "")(str.++ __woorpje_diseq_pref2_  "A" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "CQALcCP5TB" "")(str.++ __woorpje_diseq_pref2_  "P" __woorpje_diseq_suf_r2_  "")) )
(assert (=(str.++ _var_0xINPUT_126279_  "")(str.++ __woorpje_diseq_pref4_  "C" __woorpje_diseq_suf_l4_  "")) )
(assert (=(str.++  "Example:" "")(str.++ __woorpje_diseq_pref4_  "E" __woorpje_diseq_suf_r4_  "")) )
(assert (=(str.++ _var_0xINPUT_126279_  "")(str.++ __woorpje_diseq_pref4_  "C" __woorpje_diseq_suf_l4_  "")) )
(assert (=(str.++  "Example:" "")(str.++ __woorpje_diseq_pref4_  "E" __woorpje_diseq_suf_r4_  "")) )
(assert (=(str.++ _var_0xINPUT_126279_  "")(str.++ __woorpje_diseq_pref2_  "A" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "CQALcCP5TB" "")(str.++ __woorpje_diseq_pref2_  "P" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_126279_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_126279_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_126279_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_126279_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_126279_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_126279_)(- 1)) (- 1)) )
(check-sat)
