(set-logic QF_S)
(declare-fun _var_0xINPUT_29084_() String)
...
(assert (=(str.++ _var_0xINPUT_29084_  "")(str.++  "Example:" "")) )
(assert  (<= (* (str.len _var_0xINPUT_29084_)1) 9) )
(assert  (<= (* (str.len _var_0xINPUT_29084_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_29084_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_29084_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_29084_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_29084_)(- 1)) (- 1)) )
