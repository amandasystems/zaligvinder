(set-logic QF_S)
(declare-fun _var_0xINPUT_60569_() String)
...
(assert (=(str.++ _var_0xINPUT_60569_  "")(str.++ __woorpje_diseq_pref0_  "E" __woorpje_diseq_suf_r0_  "")) )
(assert (=(str.++ _var_0xINPUT_60569_  "")(str.++  "Example:" "")) )
(assert  (<= (* (str.len _var_0xINPUT_60569_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_60569_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_60569_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_60569_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_60569_)(- 1)) (- 1)) )
