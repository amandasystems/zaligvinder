...
(assert (=(str.++ _var_0xINPUT_150827_  "")(str.++ __woorpje_diseq_pref1_  "6" __woorpje_diseq_suf_r1_  "")) )
(assert (=(str.++ _var_0xINPUT_150827_  "")(str.++ __woorpje_diseq_pref2_  "6" __woorpje_diseq_suf_l2_  "")) )
...
(assert  (<= (* (str.len _var_0xINPUT_150827_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_150827_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_150827_)(- 1)) (- 11)) )
(check-sat)
