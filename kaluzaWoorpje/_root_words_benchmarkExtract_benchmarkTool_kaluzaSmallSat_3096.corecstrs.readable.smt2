(set-logic QF_S)
(declare-fun _var_0xINPUT_126404_() String)
...
(assert (=(str.++  "j2DpYJpVEE" "")(str.++ _var_0xINPUT_126404_  "")) )
(assert (=(str.++  "ywUN4ZIDAC" "")(str.++ __woorpje_diseq_pref2_  "y" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++ _var_0xINPUT_126404_  "")(str.++ __woorpje_diseq_pref2_  "j" __woorpje_diseq_suf_r2_  "")) )
(assert (=(str.++ _var_0xINPUT_126404_  "")(str.++ __woorpje_diseq_pref3_  "j" __woorpje_diseq_suf_l3_  "")) )
(assert (=(str.++  "ywUN4ZIDAC" "")(str.++ __woorpje_diseq_pref3_  "y" __woorpje_diseq_suf_r3_  "")) )
(assert (=(str.++ _var_0xINPUT_126404_  "")(str.++ __woorpje_diseq_pref3_  "j" __woorpje_diseq_suf_l3_  "")) )
(assert (=(str.++  "ywUN4ZIDAC" "")(str.++ __woorpje_diseq_pref3_  "y" __woorpje_diseq_suf_r3_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_126404_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_126404_)(- 1)) (- 1)) )
(check-sat)
