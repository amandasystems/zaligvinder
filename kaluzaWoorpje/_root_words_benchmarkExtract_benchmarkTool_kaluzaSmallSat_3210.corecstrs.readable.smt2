(set-logic QF_S)
(declare-fun _var_0xINPUT_86293_() String)
...
(assert (=(str.++ _var_0xINPUT_86293_  "")(str.++ __woorpje_diseq_pref4_  "7" __woorpje_diseq_suf_l4_  "")) )
(assert (=(str.++  "ywUN4ZIDAC" "")(str.++ __woorpje_diseq_pref4_  "C" __woorpje_diseq_suf_r4_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_86293_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_86293_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_86293_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_86293_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_86293_)(- 1)) (- 1)) )
(check-sat)
