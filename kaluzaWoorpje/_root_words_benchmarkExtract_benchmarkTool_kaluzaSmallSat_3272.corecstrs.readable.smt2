(set-logic QF_S)
(declare-fun _var_0xINPUT_48499_() String)
...
(assert (=(str.++  "pVEECEXk2p" "")(str.++ __woorpje_diseq_pref2_  "X" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++ _var_0xINPUT_48499_  "")(str.++ __woorpje_diseq_pref2_  "2" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_48499_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_48499_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_48499_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_48499_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_48499_)(- 1)) (- 1)) )
(check-sat)
