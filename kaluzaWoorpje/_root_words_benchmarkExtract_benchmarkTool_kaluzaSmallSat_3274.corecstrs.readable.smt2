(set-logic QF_S)
(declare-fun _var_0xINPUT_48582_() String)
...
(assert (=(str.++ _var_0xINPUT_48582_  "")(str.++ __woorpje_diseq_pref2_  "2" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_48582_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_48582_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_48582_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_48582_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_48582_)(- 1)) (- 1)) )
(check-sat)
