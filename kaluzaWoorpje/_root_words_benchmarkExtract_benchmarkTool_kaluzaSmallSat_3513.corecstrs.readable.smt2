(set-logic QF_S)
(declare-fun _var_0xINPUT_63289_() String)
...
(assert (=(str.++  "qXdHDo7IZR" "")(str.++ _var_0xINPUT_63289_  "")) )
(assert (=(str.++ _var_0xINPUT_63289_  "")(str.++  "qXdHDo7IZR" "")) )
(assert  (<= (* (str.len _var_0xINPUT_63289_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_63289_)(- 1)) (- 9)) )
(check-sat)
