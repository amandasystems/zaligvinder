(set-logic QF_S)
(declare-fun _var_0xINPUT_120690_() String)
...
(assert (=(str.++ _var_0xINPUT_120690_  "")(str.++  "6JX7G3VKFq" "")) )
(assert  (<= (* (str.len _var_0xINPUT_120690_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_120690_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_120690_)(- 1)) (- 9)) )
(check-sat)
