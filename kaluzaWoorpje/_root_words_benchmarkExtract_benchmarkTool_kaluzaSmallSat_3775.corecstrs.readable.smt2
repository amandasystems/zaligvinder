(set-logic QF_S)
(declare-fun _var_0xINPUT_293845_() String)
...
(assert (=(str.++ _var_0xINPUT_293845_  "")(str.++ __woorpje_diseq_pref0_  "A" __woorpje_diseq_suf_r0_  "")) )
(assert (=(str.++ _var_0xINPUT_293845_  "")(str.++  "AA1ND6MEXd" "")) )
(assert  (<= (* (str.len _var_0xINPUT_293845_)(- 1)) (- 1)) )
(check-sat)
