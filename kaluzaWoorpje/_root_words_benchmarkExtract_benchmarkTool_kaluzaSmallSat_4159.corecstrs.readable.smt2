(set-logic QF_S)
(declare-fun _var_0xINPUT_95277_() String)
...
(assert (=(str.++ _var_0xINPUT_95277_  "")(str.++  "Example:" "")) )
(assert  (<= (* (str.len _var_0xINPUT_95277_)1) 9) )
(assert  (<= (* (str.len _var_0xINPUT_95277_)(- 1)) (- 1)) )
(check-sat)
