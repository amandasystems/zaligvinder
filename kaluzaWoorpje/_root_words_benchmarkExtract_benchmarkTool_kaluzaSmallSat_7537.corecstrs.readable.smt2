(set-logic QF_S)
(declare-fun _var_0xINPUT_38869_() String)
...
(assert (=(str.++ _var_0xINPUT_38869_  "")(str.++ __woorpje_diseq_pref0_  "q" __woorpje_diseq_suf_r0_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_38869_)(- 1)) (- 1)) )
(check-sat)
