(set-logic QF_S)
(declare-fun _var_0xINPUT_287908_() String)
...
(assert (=(str.++ _var_0xINPUT_287908_  "")(str.++ __woorpje_diseq_pref2_  "y" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "ywUN4ZIDAC" "")(str.++ __woorpje_diseq_pref2_  "C" __woorpje_diseq_suf_r2_  "")) )
(assert (=(str.++  "ywUN4ZIDAC" "")(str.++ __woorpje_diseq_pref3_  "C" __woorpje_diseq_suf_l3_  "")) )
(assert (=(str.++ _var_0xINPUT_287908_  "")(str.++ __woorpje_diseq_pref3_  "y" __woorpje_diseq_suf_r3_  "")) )
(assert (=(str.++ _var_0xINPUT_287908_  "")(str.++ __woorpje_diseq_pref2_  "y" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "ywUN4ZIDAC" "")(str.++ __woorpje_diseq_pref2_  "C" __woorpje_diseq_suf_r2_  "")) )
(assert (=(str.++  "ywUN4ZIDAC" "")(str.++ __woorpje_diseq_pref3_  "C" __woorpje_diseq_suf_l3_  "")) )
(assert (=(str.++ _var_0xINPUT_287908_  "")(str.++ __woorpje_diseq_pref3_  "y" __woorpje_diseq_suf_r3_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_287908_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_287908_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_287908_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_287908_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_287908_)(- 1)) (- 1)) )
...
(assert  (<= (* (str.len _var_0xINPUT_287908_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_287908_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_287908_)(- 1)) (- 11)) )
(check-sat)
