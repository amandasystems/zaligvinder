(set-logic QF_S)
(declare-fun _var_0xINPUT_29618_() String)
...
(assert (=(str.++ _var_0xINPUT_29618_  "")(str.++ __woorpje_diseq_pref4_  "N" __woorpje_diseq_suf_l4_  "")) )
(assert (=(str.++  "CQALcCP5TB" "")(str.++ __woorpje_diseq_pref4_  "C" __woorpje_diseq_suf_r4_  "")) )
(assert (=(str.++ _var_0xINPUT_29618_  "")(str.++ __woorpje_diseq_pref4_  "N" __woorpje_diseq_suf_l4_  "")) )
(assert (=(str.++  "CQALcCP5TB" "")(str.++ __woorpje_diseq_pref4_  "C" __woorpje_diseq_suf_r4_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_29618_)1) 9) )
(assert  (<= (* (str.len _var_0xINPUT_29618_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_29618_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_29618_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_29618_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_29618_)(- 1)) (- 1)) )
