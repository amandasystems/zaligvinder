(set-logic QF_S)
(declare-fun _var_0xINPUT_245632_() String)
...
(assert (=(str.++ _var_0xINPUT_245632_  "")(str.++ __woorpje_diseq_pref3_  "X" __woorpje_diseq_suf_l3_  "")) )
(assert (=(str.++  "Example:" "")(str.++ __woorpje_diseq_pref3_  "E" __woorpje_diseq_suf_r3_  "")) )
(assert (=(str.++ _var_0xINPUT_245632_  "")(str.++ __woorpje_diseq_pref4_  "X" __woorpje_diseq_suf_l4_  "")) )
(assert (=(str.++  "CQALcCP5TB" "")(str.++ __woorpje_diseq_pref4_  "C" __woorpje_diseq_suf_r4_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_245632_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_245632_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_245632_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_245632_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_245632_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_245632_)(- 1)) (- 1)) )
