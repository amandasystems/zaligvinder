(set-logic QF_S)
(declare-fun _var_0xINPUT_232677_() String)
...
(assert (=(str.++  "ND6MEXdqBD" "")(str.++ _var_0xINPUT_232677_  "")) )
(assert (=(str.++  "ND6MEXdqBD" "")(str.++ _var_0xINPUT_232677_  "")) )
(assert (=(str.++ _var_0xINPUT_232677_  "")(str.++  "ND6MEXdqBD" "")) )
(assert (=(str.++ _var_0xINPUT_232677_  "")(str.++ __woorpje_diseq_pref4_  "N" __woorpje_diseq_suf_l4_  "")) )
(assert (=(str.++  "VEECEXk2pV" "")(str.++ __woorpje_diseq_pref4_  "V" __woorpje_diseq_suf_r4_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_232677_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_232677_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_232677_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_232677_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_232677_)(- 1)) (- 1)) )
