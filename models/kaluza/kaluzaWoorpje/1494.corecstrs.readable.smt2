(set-logic QF_S)
(declare-fun _var_0xINPUT_62687_() String)
...
(assert (=(str.++  "6JX7G3VKFq" "")(str.++ __woorpje_diseq_pref3_  "K" __woorpje_diseq_suf_l3_  "")) )
(assert (=(str.++ _var_0xINPUT_62687_  "")(str.++ __woorpje_diseq_pref3_  "q" __woorpje_diseq_suf_r3_  "")) )
(assert (=(str.++  "6JX7G3VKFq" "")(str.++ __woorpje_diseq_pref3_  "K" __woorpje_diseq_suf_l3_  "")) )
(assert (=(str.++ _var_0xINPUT_62687_  "")(str.++ __woorpje_diseq_pref3_  "q" __woorpje_diseq_suf_r3_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_62687_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_62687_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_62687_)(- 1)) (- 9)) )
(assert  (<= (* (str.len _var_0xINPUT_62687_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_62687_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_62687_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_62687_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_62687_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_62687_)(- 1)) (- 1)) )
