(set-logic QF_S)
(declare-fun _var_0xINPUT_47697_() String)
...
(assert (=(str.++ _var_0xINPUT_47697_  "")(str.++ __woorpje_diseq_pref2_  "m" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "Example:" "")(str.++ __woorpje_diseq_pref2_  ":" __woorpje_diseq_suf_r2_  "")) )
(assert (=(str.++ _var_0xINPUT_47697_  "")(str.++ __woorpje_diseq_pref2_  "m" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "Example:" "")(str.++ __woorpje_diseq_pref2_  ":" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_47697_)1) 9) )
(assert  (<= (* (str.len _var_0xINPUT_47697_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_47697_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_47697_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_47697_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_47697_)(- 1)) (- 1)) )
