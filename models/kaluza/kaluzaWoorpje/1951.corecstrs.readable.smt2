(set-logic QF_S)
(declare-fun _var_0xINPUT_122151_() String)
...
(assert (=(str.++ _var_0xINPUT_122151_  "")(str.++ __woorpje_diseq_pref2_  "2" __woorpje_diseq_suf_r2_  "")) )
(assert (=(str.++  "pVEECEXk2p" "")(str.++ __woorpje_diseq_pref2_  "p" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++ _var_0xINPUT_122151_  "")(str.++ __woorpje_diseq_pref2_  "2" __woorpje_diseq_suf_r2_  "")) )
(assert (=(str.++ _var_0xINPUT_122151_  "")(str.++ __woorpje_diseq_pref4_  "2" __woorpje_diseq_suf_l4_  "")) )
(assert (=(str.++  "4PH2ujcENG" "")(str.++ __woorpje_diseq_pref4_  "4" __woorpje_diseq_suf_r4_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_122151_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_122151_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_122151_)1) 9) )
(assert  (<= (* (str.len _var_0xINPUT_122151_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_122151_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_122151_)1) 9) )
(assert  (<= (* (str.len _var_0xINPUT_122151_)(- 1)) (- 1)) )
