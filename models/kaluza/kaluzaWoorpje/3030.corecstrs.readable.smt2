(set-logic QF_S)
(declare-fun _var_0xINPUT_218941_() String)
...
(assert (=(str.++ _var_0xINPUT_218941_  "")(str.++  "Example:" "")) )
(assert  (<= (* (str.len _var_0xINPUT_218941_)1) 9) )
(assert  (<= (* (str.len _var_0xINPUT_218941_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_218941_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_218941_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_218941_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_218941_)(- 1)) (- 1)) )
