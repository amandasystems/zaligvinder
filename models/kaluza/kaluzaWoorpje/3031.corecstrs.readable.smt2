(set-logic QF_S)
(declare-fun _var_0xINPUT_218951_() String)
...
(assert (=(str.++ _var_0xINPUT_218951_  "")(str.++  "Example:" "")) )
(assert  (<= (* (str.len _var_0xINPUT_218951_)1) 9) )
(assert  (<= (* (str.len _var_0xINPUT_218951_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_218951_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_218951_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_218951_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_218951_)(- 1)) (- 1)) )
