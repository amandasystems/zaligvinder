(set-logic QF_S)
(declare-fun _var_0xINPUT_28294_() String)
...
(assert (=(str.++ _var_0xINPUT_28294_  "")(str.++ __woorpje_diseq_pref0_  "d" __woorpje_diseq_suf_r0_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_28294_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_28294_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_28294_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_28294_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_28294_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_28294_)1) 9) )
(check-sat)
