(set-logic QF_S)
(declare-fun _var_0xINPUT_59708_() String)
...
(assert (=(str.++ _var_0xINPUT_59708_  "")(str.++  "Example:" "")) )
(assert  (<= (* (str.len _var_0xINPUT_59708_)1) 9) )
(assert  (<= (* (str.len _var_0xINPUT_59708_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_59708_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_59708_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_59708_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_59708_)(- 1)) (- 1)) )
