(set-logic QF_S)
(declare-fun _var_0xINPUT_125145_() String)
...
(assert (=(str.++ _var_0xINPUT_125145_  "")(str.++ __woorpje_diseq_pref0_  "A" __woorpje_diseq_suf_r0_  "")) )
(assert (=(str.++ _var_0xINPUT_125145_  "")(str.++ __woorpje_diseq_pref3_  "o" __woorpje_diseq_suf_l3_  "")) )
(assert (=(str.++  "AA1ND6MEXd" "")(str.++ __woorpje_diseq_pref3_  "d" __woorpje_diseq_suf_r3_  "")) )
(assert (=(str.++ _var_0xINPUT_125145_  "")(str.++ __woorpje_diseq_pref3_  "o" __woorpje_diseq_suf_l3_  "")) )
(assert (=(str.++  "AA1ND6MEXd" "")(str.++ __woorpje_diseq_pref3_  "d" __woorpje_diseq_suf_r3_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_125145_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_125145_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_125145_)(- 1)) (- 1)) )
(check-sat)
