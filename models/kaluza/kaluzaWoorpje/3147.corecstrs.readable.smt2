(set-logic QF_S)
(declare-fun _var_0xINPUT_233629_() String)
...
(assert (=(str.++ _var_0xINPUT_233629_  "")(str.++ __woorpje_diseq_pref0_  "C" __woorpje_diseq_suf_r0_  "")) )
(assert (=(str.++ _var_0xINPUT_233629_  "")(str.++  "CQALcCP5TB" "")) )
(assert  (<= (* (str.len _var_0xINPUT_233629_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_233629_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_233629_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_233629_)(- 1)) (- 1)) )
(check-sat)
