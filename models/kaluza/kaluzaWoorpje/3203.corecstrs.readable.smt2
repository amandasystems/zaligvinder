(set-logic QF_S)
(declare-fun _var_0xINPUT_26384_() String)
...
(assert (=(str.++ _var_0xINPUT_26384_  "")(str.++ __woorpje_diseq_pref2_  "e" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_26384_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_26384_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_26384_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_26384_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_26384_)(- 1)) (- 11)) )
(check-sat)
