(set-logic QF_S)
(declare-fun _var_0xINPUT_96592_() String)
...
(assert (=(str.++ _var_0xINPUT_96592_  "")(str.++ __woorpje_diseq_pref0_  "Z" __woorpje_diseq_suf_r0_  "")) )
(assert (=(str.++ _var_0xINPUT_96592_  "")(str.++ __woorpje_diseq_pref3_  "y" __woorpje_diseq_suf_l3_  "")) )
(assert (=(str.++  "j2DpYJpVEE" "")(str.++ __woorpje_diseq_pref3_  "j" __woorpje_diseq_suf_r3_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_96592_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_96592_)1) 9) )
(assert  (<= (* (str.len _var_0xINPUT_96592_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_96592_)(- 1)) (- 1)) )
(check-sat)
