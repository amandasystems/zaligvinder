(set-logic QF_S)
(declare-fun _var_0xINPUT_36077_() String)
...
(assert (=(str.++ _var_0xINPUT_36077_  "")(str.++ __woorpje_diseq_pref2_  "C" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "AUEAICDdfN" "")(str.++ __woorpje_diseq_pref2_  "N" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_36077_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_36077_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_36077_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_36077_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_36077_)(- 1)) (- 1)) )
(check-sat)
