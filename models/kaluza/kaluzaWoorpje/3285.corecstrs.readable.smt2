(set-logic QF_S)
(declare-fun _var_0xINPUT_202193_() String)
...
(assert (=(str.++ _var_0xINPUT_202193_  "")(str.++ __woorpje_diseq_pref0_  "B" __woorpje_diseq_suf_r0_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_202193_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_202193_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_202193_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_202193_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_202193_)(- 1)) (- 1)) )
