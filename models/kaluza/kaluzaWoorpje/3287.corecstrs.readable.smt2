(set-logic QF_S)
(declare-fun _var_0xINPUT_221877_() String)
...
(assert (=(str.++ _var_0xINPUT_221877_  "")(str.++ __woorpje_diseq_pref0_  "3" __woorpje_diseq_suf_r0_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_221877_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_221877_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_221877_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_221877_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_221877_)(- 1)) (- 1)) )
