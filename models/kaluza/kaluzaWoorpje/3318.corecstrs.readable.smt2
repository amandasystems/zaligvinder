(set-logic QF_S)
(declare-fun _var_0xINPUT_429544_() String)
...
(assert (=(str.++ _var_0xINPUT_429544_  "")(str.++ __woorpje_diseq_pref0_  "4" __woorpje_diseq_suf_r0_  "")) )
(assert (=(str.++ _var_0xINPUT_429544_  "")(str.++ __woorpje_diseq_pref2_  "4" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "Example:" "")(str.++ __woorpje_diseq_pref2_  "E" __woorpje_diseq_suf_r2_  "")) )
(assert (=(str.++ _var_0xINPUT_429544_  "")(str.++  "4PH2ujcENG" "")) )
(assert  (<= (* (str.len _var_0xINPUT_429544_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_429544_)(- 1)) (- 1)) )
(check-sat)
