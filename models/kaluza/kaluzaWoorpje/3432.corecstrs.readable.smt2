(set-logic QF_S)
(declare-fun _var_0xINPUT_80362_() String)
...
(assert (=(str.++ _var_0xINPUT_80362_  "")(str.++ __woorpje_diseq_pref0_  "c" __woorpje_diseq_suf_r0_  "")) )
(assert (=(str.++ _var_0xINPUT_80362_  "")(str.++ __woorpje_diseq_pref2_  "c" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "Example:" "")(str.++ __woorpje_diseq_pref2_  "E" __woorpje_diseq_suf_r2_  "")) )
(assert (=(str.++  "cm6AfB9De3" "")(str.++ _var_0xINPUT_80362_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_80362_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_80362_)(- 1)) (- 1)) )
(check-sat)
