...
(assert (=(str.++ _var_0xINPUT_464210_  "")(str.++ __woorpje_diseq_pref2_  "k" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "VEECEXk2pV" "")(str.++ __woorpje_diseq_pref2_  "p" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_464210_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_464210_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_464210_)1) 9) )
(assert  (<= (* (str.len _var_0xINPUT_464210_)(- 1)) (- 1)) )
(check-sat)
