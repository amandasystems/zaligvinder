...
(assert (=(str.++  "A9jaaDKZbG" "")(str.++ _var_0xINPUT_102793_  "")) )
(assert (=(str.++ _var_0xINPUT_102793_  "")(str.++  "A9jaaDKZbG" "")) )
(assert  (<= (* (str.len _var_0xINPUT_102793_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_102793_)(- 1)) (- 9)) )
(check-sat)
