...
(assert (=(str.++  "4PH2ujcENG" "")(str.++ _var_0xINPUT_133567_  "")) )
(assert (=(str.++ _var_0xINPUT_133567_  "")(str.++  "4PH2ujcENG" "")) )
(assert  (<= (* (str.len _var_0xINPUT_133567_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_133567_)(- 1)) (- 9)) )
(check-sat)
