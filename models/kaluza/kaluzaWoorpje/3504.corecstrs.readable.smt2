(set-logic QF_S)
(declare-fun _var_0xINPUT_157936_() String)
...
(assert (=(str.++  "CQALcCP5TB" "")(str.++ _var_0xINPUT_157936_  "")) )
(assert (=(str.++ _var_0xINPUT_157936_  "")(str.++  "CQALcCP5TB" "")) )
(assert  (<= (* (str.len _var_0xINPUT_157936_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_157936_)(- 1)) (- 9)) )
(check-sat)
