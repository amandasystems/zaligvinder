(set-logic QF_S)
(declare-fun _var_0xINPUT_244257_() String)
...
(assert (=(str.++  "YY8CBEMy6Q" "")(str.++ _var_0xINPUT_244257_  "")) )
(assert (=(str.++ _var_0xINPUT_244257_  "")(str.++  "YY8CBEMy6Q" "")) )
(assert  (<= (* (str.len _var_0xINPUT_244257_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_244257_)(- 1)) (- 9)) )
(check-sat)
