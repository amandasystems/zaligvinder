(set-logic QF_S)
(declare-fun _var_0xINPUT_255665_() String)
...
(assert (=(str.++  "3s71lxYG6e" "")(str.++ _var_0xINPUT_255665_  "")) )
(assert (=(str.++ _var_0xINPUT_255665_  "")(str.++  "3s71lxYG6e" "")) )
(assert  (<= (* (str.len _var_0xINPUT_255665_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_255665_)(- 1)) (- 9)) )
(check-sat)
