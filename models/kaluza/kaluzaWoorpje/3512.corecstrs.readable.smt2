(set-logic QF_S)
(declare-fun _var_0xINPUT_60120_() String)
...
(assert (=(str.++  "qXdHDo7IZR" "")(str.++ _var_0xINPUT_60120_  "")) )
(assert (=(str.++ _var_0xINPUT_60120_  "")(str.++  "qXdHDo7IZR" "")) )
(assert  (<= (* (str.len _var_0xINPUT_60120_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_60120_)(- 1)) (- 9)) )
(check-sat)
