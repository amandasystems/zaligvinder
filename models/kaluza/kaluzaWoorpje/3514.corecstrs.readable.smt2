(set-logic QF_S)
(declare-fun _var_0xINPUT_80938_() String)
...
(assert (=(str.++  "AA1ND6MEXd" "")(str.++ _var_0xINPUT_80938_  "")) )
(assert (=(str.++ _var_0xINPUT_80938_  "")(str.++  "AA1ND6MEXd" "")) )
(assert  (<= (* (str.len _var_0xINPUT_80938_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_80938_)(- 1)) (- 9)) )
(check-sat)
