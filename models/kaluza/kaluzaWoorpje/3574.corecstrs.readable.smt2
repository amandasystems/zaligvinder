(set-logic QF_S)
(declare-fun _var_0xINPUT_149471_() String)
...
(assert (=(str.++ _var_0xINPUT_149471_  "")(str.++  "AUEAICDdfN" "")) )
(assert  (<= (* (str.len _var_0xINPUT_149471_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_149471_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_149471_)(- 1)) (- 9)) )
(check-sat)
