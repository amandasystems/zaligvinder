(set-logic QF_S)
(declare-fun _var_0xINPUT_242575_() String)
...
(assert (=(str.++ _var_0xINPUT_242575_  "")(str.++ __woorpje_diseq_pref2_  "m" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "4PH2ujcENG" "")(str.++ __woorpje_diseq_pref2_  "G" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_242575_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_242575_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_242575_)(- 1)) (- 9)) )
(check-sat)
