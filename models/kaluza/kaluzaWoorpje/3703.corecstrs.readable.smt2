(set-logic QF_S)
(declare-fun _var_0xINPUT_269547_() String)
...
(assert (=(str.++ _var_0xINPUT_269547_  "")(str.++ __woorpje_diseq_pref2_  "a" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "ywUN4ZIDAC" "")(str.++ __woorpje_diseq_pref2_  "C" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_269547_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_269547_)(- 1)) (- 1)) )
(assert  (<= (* (str.len _var_0xINPUT_269547_)(- 1)) (- 9)) )
(check-sat)
