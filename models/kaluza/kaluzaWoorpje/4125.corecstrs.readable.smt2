(set-logic QF_S)
(declare-fun _var_0xINPUT_339734_() String)
...
(assert (=(str.++ _var_0xINPUT_339734_  "")(str.++ __woorpje_diseq_pref2_  "Y" __woorpje_diseq_suf_l2_  "")) )
(assert (=(str.++  "3s71lxYG6e" "")(str.++ __woorpje_diseq_pref2_  "e" __woorpje_diseq_suf_r2_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_339734_)(- 1)) (- 11)) )
(assert  (<= (* (str.len _var_0xINPUT_339734_)(- 1)) (- 1)) )
(check-sat)
