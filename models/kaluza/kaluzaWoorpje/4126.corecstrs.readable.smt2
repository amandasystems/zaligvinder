(set-logic QF_S)
(declare-fun _var_0xINPUT_108876_() String)
...
(assert (=(str.++ _var_0xINPUT_108876_  "")(str.++  "Example:" "")) )
(assert  (<= (* (str.len _var_0xINPUT_108876_)1) 9) )
(assert  (<= (* (str.len _var_0xINPUT_108876_)(- 1)) (- 1)) )
(check-sat)
