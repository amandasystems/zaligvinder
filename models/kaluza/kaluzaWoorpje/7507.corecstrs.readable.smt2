(set-logic QF_S)
(declare-fun _var_0xINPUT_128396_() String)
...
(assert (=(str.++ _var_0xINPUT_128396_  "")(str.++ __woorpje_diseq_pref1_  "o" __woorpje_diseq_suf_l1_  "")) )
(assert (=(str.++  "qXdHDo7IZR" "")(str.++ __woorpje_diseq_pref1_  "R" __woorpje_diseq_suf_r1_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_128396_)(- 1)) (- 1)) )
(check-sat)
