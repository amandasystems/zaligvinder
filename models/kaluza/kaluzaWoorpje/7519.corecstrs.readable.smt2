(set-logic QF_S)
(declare-fun _var_0xINPUT_204072_() String)
...
(assert (=(str.++ _var_0xINPUT_204072_  "")(str.++ __woorpje_diseq_pref0_  "2" __woorpje_diseq_suf_r0_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_204072_)(- 1)) (- 1)) )
(check-sat)
