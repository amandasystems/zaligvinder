(set-logic QF_S)
(declare-fun _var_0xINPUT_64562_() String)
...
(assert (=(str.++ _var_0xINPUT_64562_  "")(str.++ __woorpje_diseq_pref0_  "G" __woorpje_diseq_suf_r0_  "")) )
(assert  (<= (* (str.len _var_0xINPUT_64562_)(- 1)) (- 1)) )
(check-sat)
